export const TrackerToolbar = () => {
  return (
    <div className="flex items-center gap-3 p-4 border-b border-neutral-800/80">
      ...
      <button className="flex items-center gap-2 px-3 py-1.5 bg-[#1E1E1E] border border-neutral-700 rounded-md text-sm text-gray-200 hover:bg-neutral-800 transition-colors">
        <svg
