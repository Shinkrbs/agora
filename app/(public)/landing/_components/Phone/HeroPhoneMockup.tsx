...
export function HeroPhoneMockup() {
  return (
    <div className="relative flex justify-center">
      {/* Background glow */}
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-75 w-75 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/60 blur-[80px]"></div>
      ...
      >
        {/* Phone container */}
        <div className="flex h-140 w-75 flex-col overflow-hidden rounded-[2.5rem] border-8 border-border bg-card p-4 text-card-foreground shadow-2xl">
          {/* Top Header / App Bar */}
