...
import { Shield, CheckSquare, Eye, Star, Radio } from "lucide-react";
            ...
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <Button
                  asChild
                  size="lg"
                  className="px-8 py-6 text-base rounded-md font-semibold"
                >
                  <Link href="/signup">Get Started</Link>
                </Button>

                {/* CHANGED: Removed hardcoded bg/text colors so it matches "Get Started" */}
                <Button
                  asChild
                  size="lg"
                  className="px-6 py-6 text-base rounded-md font-semibold flex items-center gap-2"
                >
                  <Link href="/live-election">
                    ...
                    {/* Icon - Inherits text color automatically now */}
                  ...
                  <div key={idx} className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className=" font-mono mt-1 text-sm text-muted-foreground leading-relaxed">
                        ...
                        {idx === 1 &&
                          "Set election dates, add candidates with photos, and upload your voter list."}
                        {idx === 2 &&
            ...
            <div className="bg-primary rounded-[2.5rem] p-10 md:p-16 text-center max-w-5xl mx-auto shadow-xl">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Button
                  variant="secondary"
                  size="lg"
                  className="font-semibold px-8 py-6 rounded-xl text-base"
                >
